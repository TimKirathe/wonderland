  ...
  return (
    <div className="mt-16">
      <div className="text-center mb-12">
        <h3 className="text-3xl font-bold mb-6">Our Beliefs & Values</h3>
      ...
      <div className="mt-12 bg-accent/10 rounded-3xl p-8 max-w-4xl mx-auto">
        <h4 className="text-2xl font-bold text-center mb-6">Our Core Values</h4>
        <div className="flex flex-wrap justify-center gap-4">
          <div className="bg-white/50 dark:bg-gray-800/50 px-6 py-3 rounded-full">
            <span className="font-semibold text-primary">✨ Godliness</span>
          </div>
          <div className="bg-white/50 dark:bg-gray-800/50 px-6 py-3 rounded-full">
            <span className="font-semibold text-primary">❤️ Love</span>
          </div>
          <div className="bg-white/50 dark:bg-gray-800/50 px-6 py-3 rounded-full">
            <span className="font-semibold text-primary">💪 Hard Work</span>
          </div>
          <div className="bg-white/50 dark:bg-gray-800/50 px-6 py-3 rounded-full">
